 ...
 */
package com.mycompany.chat_app_poe_pt1;
...
public class Login {
    public void Register(User user1, Scanner input) {
        ...
        System.out.println("\nEnter a user name (must have less than 5 character and an underscore): ");
       ...
       char[] usernameCharacters = userName.toCharArray();
        ...
        if(!validUserName) {
            System.out.println("\nUser name requirements met: False");
            return;
        } else {
    ...
    public void loginUser(User user1, Scanner input) {
        ...
        String inputCellPhoneNumber = input.nextLine();
            
        String logginStatus = LoginStatus(user1, inputUsername, inputPassword, inputCellPhoneNumber);
    ...
    public static String LoginStatus(User user1, String inputUsername, String inputPassword, String inputCellPhoneNumber) {
        ...
        if (!inputCellPhoneNumber.equals(user1.getCellPhoneNumber()) || user1.getCellPhoneNumber() == null) {
